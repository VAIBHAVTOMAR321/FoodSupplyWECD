...
const ITCellDashBoard = () => {
  ...
  const fetchThrDistributions = async () => {
    try {
      ...
      console.error("Failed to fetch THR distributions for IT Cell:", err);
    }
  };
  ...
  const fetchHcmDistributions = async () => {
    try {
      ...
      console.error("Failed to fetch HCM distributions for IT Cell:", err);
    }
  };
  ...
  const fetchAllData = async () => {
    ...
    try {
      await Promise.all([
        fetchThrDistributions(),
        fetchHcmDistributions(),
        fetchHcmFoodItems(),
        fetchThrFoodItems(),
      ]);
    } catch (err) {
      setError("Failed to fetch IT Cell dashboard data.");
    } finally {
      setLoading(false);
    }
  };
